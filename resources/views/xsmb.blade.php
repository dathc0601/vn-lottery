...
<div>
    ...
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex-1 min-w-0">
            ...
            <!-- Results Info (only show for specific date) -->
            @if(isset($isSpecificDate) && $isSpecificDate && $provinces->count() > 0)
            ...
            @if(count($results) > 0)
                ...
                <div class="text-center mt-6 mb-4" id="load-more-container">
                    <button
                        ...
                        <span id="load-more-text">Xem thêm KQXS MB</span>
                    </button>
                </div>
            @else
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (dateInput && dateInput.value) {
                ...
                window.location.href = `{{ route('xsmb.date', ['date' => '__DATE__']) }}`.replace('__DATE__', formattedDate);
            } else {
