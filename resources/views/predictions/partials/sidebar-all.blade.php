            ...
            <div class="p-4 space-y-2">
                @foreach($regions as $r)
                    <a href="{{ route('prediction.' . $r['slug'] . '.index') }}"
                       class="flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-[#ff6600] hover:bg-gray-50 transition-all">
                        <div class="flex items-center gap-3">
                            <span class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 text-gray-600">
