                    ...
                    @foreach($scheduleData as $day)
                        <li>
                            ...
                            @foreach($day['provinces'] as $index => $province)
                                <a href="{{ route('province.detail', ['code' => $province->code, 'slug' => $province->slug]) }}" class="text-[#0066cc] hover:text-[#ff6600]">{{ $province->name }}</a>@if($index < count($day['provinces']) - 1), @endif
                            @endforeach
                        </li>
                    @endforeach
                </ul>
