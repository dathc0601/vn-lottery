...
@section('title', 'Mega 6/45 - Kết Quả Xổ Số Vietlott')
...
@section('breadcrumb')
    ...
    <span class="mx-1">/</span>
    <span class="text-gray-800 font-medium">Mega 6/45</span>
@endsection
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="bg-white rounded shadow overflow-hidden mb-4">
                <div class="bg-[#ff6600] text-white px-4 py-2">
                    <h1 class="text-lg font-bold">Kết Quả Xổ Số Vietlott - Mega 6/45</h1>
                </div>
            </div>

            <!-- Tab Navigation -->
            <x-vietlott.tab-navigation activeGame="mega645" />
            ...
            @else
                <div class="border border-yellow-400 bg-yellow-50 px-4 py-3 rounded mb-4">
                    ...
                    <p class="text-sm text-yellow-700 mt-1">
                        Dữ liệu Mega 6/45 sẽ được cập nhật sau mỗi kỳ quay.
                    </p>
                </div>
            @endif
            ...
            <div class="sidebar-section mt-6">
                <div class="sidebar-header">Về Mega 6/45</div>
                <div class="p-4 text-sm text-gray-700">
                    <p class="mb-3"><strong>Mega 6/45</strong> là sản phẩm xổ số điện toán của Vietlott với jackpot khởi điểm 12 tỷ đồng.</p>
                    <ul class="list-disc list-inside space-y-1 mb-3">
                        <li>Chọn 6 số từ 01 đến 45</li>
                        <li>Quay số vào Thứ 4, Thứ 6 và Chủ nhật</li>
                        <li>Thời gian quay: 18:00</li>
                        <li>Giá vé: {{ $gameInfo['ticket_price'] }}đ</li>
                    </ul>
                    <p><strong>Cơ cấu giải thưởng:</strong></p>
                    <ul class="list-disc list-inside space-y-1 mt-2">
                        <li>Jackpot: Trúng 6 số - Từ 12 tỷ đồng</li>
                        <li>Giải Nhất: Trúng 5 số - 10.000.000đ</li>
                        <li>Giải Nhì: Trúng 4 số - 300.000đ</li>
                        <li>Giải Ba: Trúng 3 số - 30.000đ</li>
                    </ul>
                </div>
            </div>
