...
@section('title', 'Max 3D - Kết Quả Xổ Số Vietlott')
...
@section('breadcrumb')
    ...
    <span class="mx-1">/</span>
    <span class="text-gray-800 font-medium">Max 3D</span>
@endsection
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="bg-white rounded shadow overflow-hidden mb-4">
                <div class="bg-[#ff6600] text-white px-4 py-2">
                    <h1 class="text-lg font-bold">Kết Quả Xổ Số Vietlott - Max 3D</h1>
                </div>
            </div>

            <!-- Tab Navigation -->
            <x-vietlott.tab-navigation activeGame="max3d" />
            ...
            @else
                <div class="border border-yellow-400 bg-yellow-50 px-4 py-3 rounded mb-4">
                    ...
                    <p class="text-sm text-yellow-700 mt-1">
                        Dữ liệu Max 3D sẽ được cập nhật sau mỗi kỳ quay.
                    </p>
                </div>
            @endif
            ...
            <div class="sidebar-section mt-6">
                <div class="sidebar-header">Về Max 3D</div>
                <div class="p-4 text-sm text-gray-700">
                    <p class="mb-3"><strong>Max 3D</strong> là sản phẩm xổ số điện toán đơn giản của Vietlott, quay hàng ngày.</p>
                    <ul class="list-disc list-inside space-y-1 mb-3">
                        <li>Chọn 1 bộ 3 số từ 000 đến 999</li>
                        <li>Quay số hàng ngày</li>
                        <li>Thời gian quay: 18:00</li>
                        <li>Giá vé: {{ $gameInfo['ticket_price'] }}đ</li>
                    </ul>
                    <p><strong>Cơ cấu giải thưởng:</strong></p>
                    <ul class="list-disc list-inside space-y-1 mt-2">
                        <li>Giải Đặc biệt: 1.000.000đ</li>
                        <li>Giải Nhất: 350.000đ</li>
                        <li>Giải Nhì: 210.000đ</li>
                        <li>Giải Ba: 100.000đ</li>
                    </ul>
                </div>
            </div>
