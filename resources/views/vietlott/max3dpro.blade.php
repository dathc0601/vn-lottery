...
@section('title', 'Max 3D Pro - Kết Quả Xổ Số Vietlott')
...
@section('breadcrumb')
    ...
    <span class="mx-1">/</span>
    <span class="text-gray-800 font-medium">Max 3D Pro</span>
@endsection
...
<div>
    ...
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex-1 min-w-0">
            ...
            <!-- Tab Navigation -->
            <x-vietlott.tab-navigation activeGame="max3dpro" />
            ...
            @else
                <div class="border border-yellow-400 bg-yellow-50 px-4 py-3 rounded mb-4">
                    ...
                    <p class="text-sm text-yellow-700 mt-1">
                        Dữ liệu Max 3D Pro sẽ được cập nhật sau mỗi kỳ quay.
                    </p>
                </div>
            @endif
            ...
            <div class="sidebar-section mt-6">
                <div class="sidebar-header">Về Max 3D Pro</div>
                <div class="p-4 text-sm text-gray-700">
                    <p class="mb-3"><strong>Max 3D Pro</strong> là phiên bản nâng cao của Max 3D với giải thưởng cao hơn, jackpot lên đến 2 tỷ đồng.</p>
                    <ul class="list-disc list-inside space-y-1 mb-3">
                        <li>Chọn 1 bộ 3 số từ 000 đến 999</li>
                        <li>Quay số vào Thứ 2, Thứ 4 và Thứ 6</li>
                    ...
                    <ul class="list-disc list-inside space-y-1 mt-2">
                        ...
                        <li>Giải Phụ Đặc biệt: 400.000.000đ</li>
                        <li>Giải Nhất: 30.000.000đ</li>
                        <li>Giải Nhì: 10.000.000đ</li>
                        <li>Giải Ba: 5.000.000đ</li>
                        <li>Giải Tư: 1.000.000đ</li>
                        <li>Giải Năm: 400.000đ</li>
                        <li>Giải Sáu: 200.000đ</li>
                    </ul>
                </div>
            </div>
